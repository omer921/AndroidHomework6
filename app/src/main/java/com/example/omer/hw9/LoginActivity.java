...
public class LoginActivity extends FirebaseLoginBaseActivity{
    ...
    /* String Constants */
    private static final String FIREBASEREF = "https://inclass1.firebaseio.com/";
    private static final String FIREBASE_ERROR = "Firebase Error";
    private static final String USER_ERROR = "User Error";
    private static final String LOGIN_SUCCESS = "Login Success";
    private static final String LOGIN_SUCCESS2 = "Login NOT";
    ...
    public void onFirebaseLoggedOut() {
       // Toast.makeText(getApplicationContext(), LOGIN_SUCCESS2, Toast.LENGTH_SHORT).show();
    }
